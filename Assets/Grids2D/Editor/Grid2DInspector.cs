    ...
    public class Grids2DInspector : Editor {
        ...
        public override void OnInspectorGUI () {
            ...
            if (grid.gridTopology == GRID_TOPOLOGY.Irregular) {
                ...
                grid.columnCount = EditorGUILayout.IntField(grid.columnCount);
                EditorGUILayout.EndHorizontal ();
                EditorGUILayout.BeginHorizontal ();
                GUILayout.Label ("Rows", GUILayout.Width (120));
                grid.rowCount = EditorGUILayout.IntField(grid.rowCount);
                EditorGUILayout.EndHorizontal ();
            }
            ...
            if (grid.showTerritories) {
                ...
                grid.territoryFrontiersColor = EditorGUILayout.ColorField(label: GUIContent.none, value: grid.territoryFrontiersColor, showEyedropper: true, showAlpha: true, hdr: true, options: GUILayout.Width(50));
            }
            EditorGUILayout.EndHorizontal ();
            ...
            if (grid.showCells) {
                ...
                grid.cellBorderColor = EditorGUILayout.ColorField(label: GUIContent.none, value: grid.cellBorderColor, showEyedropper: true, showAlpha: true, hdr: true, options: GUILayout.Width(50));
            }
            EditorGUILayout.EndHorizontal ();
            EditorGUILayout.BeginHorizontal ();
            GUILayout.Label ("  Highlight Color", GUILayout.Width (120));
            ...
            EditorGUILayout.BeginHorizontal();
            GUILayout.Label("Surfaces Order", GUILayout.Width(120));
            grid.surfacesTypeOrder = (SURFACES_TYPE_ORDER)EditorGUILayout.EnumPopup(grid.surfacesTypeOrder);
            EditorGUILayout.EndHorizontal();
