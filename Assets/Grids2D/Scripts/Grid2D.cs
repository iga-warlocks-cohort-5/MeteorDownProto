...
namespace Grids2D {
    ...
    public enum SURFACES_TYPE_ORDER {
        CellsOverTerritories = 0,
        TerritoriesOverCells = 1
    }

    public partial class Grid2D : MonoBehaviour {

        public SURFACES_TYPE_ORDER _surfacesTypeOrder = SURFACES_TYPE_ORDER.CellsOverTerritories;
        /// <summary>
        /// Specifies if cell surfaces should be rendered on top of territories surfaces or viceversa
        /// </summary>
        public SURFACES_TYPE_ORDER surfacesTypeOrder {
            get { return _surfacesTypeOrder; }
            set {
                if (_surfacesTypeOrder != value) {
                    _surfacesTypeOrder = value;
                    isDirty = true;
                }
            }
        }
        ...
        public Grid2DMove MoveTo(GameObject o, int row, int column, float velocity = 0, float elevation = 0) {
        ...
        /// <param name="velocity">Speed in meters per seconds. A value of 0 moves the gameobject immediately to the destination.</param>
        /// <param name="elevation">Optional offset from the grid surface</param>
        public Grid2DMove MoveTo(GameObject o, int cellIndex, float velocity = 0, float elevation = 0) {
        ...
        /// <param name="velocity">Speed in meters per seconds. A value of 0 moves the gameobject immediately to the destination.</param>
        /// <param name="elevation">Optional offset from the grid surface</param>
        public Grid2DMove MoveTo(GameObject o, List<int> positions, float velocity = 0, float elevation = 0) {
            Grid2DMove mv = o.GetComponent<Grid2DMove>();
            if (mv == null) {
                mv = o.AddComponent<Grid2DMove>();
            }
            mv.grid = this;
