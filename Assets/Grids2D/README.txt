...
You may upgrade to Terrain Grid System, which in addition to 2D grids also supports dynamic 3D grids over Unity terrain or mesh.
...
Version 6.8
- Added "Surfaces Order" option to inspector. Choose which surfaces render behind: cells or territories.

Version 6.7.3
- Fixes and improvements to some demo scenes and CellFlash method

Version 6.7.2
- Updated documentation with additional details

Version 6.7.1
- [Fix] Removed redundant territory.index field. Use TerritoryGetIndex() to get the index of a territory

Version 6.7
- Increased default max grid size to 200x200
- CHANGE: API: MoveTo() methods now accepts a velocity parameter instead of a duration
- API: added OnMoveEnd, OnCellMove events to CellMove script
- API: added MovePause, MoveResume, MovePauseToggle
